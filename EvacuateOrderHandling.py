...
class OrderHandling:
    ...
    def scannhouse(self, chekpoint):
        self.driveTrain.followLine(43, RobotContainer.AGGRESSION, RobotContainer.BLUELINE + RobotContainer.REDLINE, 2)
        time.sleep(0.1)
        ...
        if c_color == "None":
            self.driveTrain.driveForward(50, -4.2)
        else:
            self.driveTrain.driveForward(30, -2.1)
